<?php
	...
	class DatabaseObject_Donator extends DatabaseObject
	{

		public function __construct($db)
		{
			
			parent::__construct($db, 'donator', 'donator_id');
			$this->add('donate_amount');
			$this->add('input_donate_amount');
			$this->add('total_donate_amount');
			$this->add('first_name');
			$this->add('last_name');
			$this->add('email');
			$this->add('address');
