<?php
	...
	class MemberpreviewController extends Profilehelper
	{
	
		public function preDispatch()
		{
			parent::preDispatch('clubImage', 'clubmemberpreview', 'member', 'L');
		...
		public function indexAction()
		{
			...
			$this->breadcrumbs->addStep('members', $this->geturl('index'));
