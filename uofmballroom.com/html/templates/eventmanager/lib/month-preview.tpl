...
{else}
	<dl>
		...
		<dt>
			...
			<span class="status button"><a  href="{geturl action='productstat' controller='ordermanager'}?ID={$post->getId()}&name={$post->profile->name}&type=event">View Registration Statistics</a></span>
